ALTER TABLE public.app_settings
  ADD COLUMN IF NOT EXISTS embedding_schema_dimensions integer;

UPDATE public.app_settings
SET embedding_schema_dimensions = coalesce(embedding_schema_dimensions, embedding_vector_dimensions, 1536)
WHERE embedding_schema_dimensions IS NULL;

ALTER TABLE public.app_settings
  ALTER COLUMN embedding_schema_dimensions SET DEFAULT 1536;
...
BEGIN
  ...
  SELECT
    ...
    greatest(coalesce((_settings #>> '{embeddings,schemaDimensions}')::integer, app_settings.embedding_schema_dimensions, app_settings.embedding_vector_dimensions, 1536), 1),
