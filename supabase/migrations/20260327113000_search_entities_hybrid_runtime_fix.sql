-- Reapply the latest search_entities_hybrid definition for environments where
-- the function was already created before the representative-field and empty-array fixes.
